@ECHO OFF
TITLE ServiceConsumerProviderVis
...
CD ServiceConsumerProviderVis

REM Start the Model
START javaw -Xss10M -Xmx400M -cp %CP% repast.simphony.runtime.RepastMain ./ServiceConsumerProviderVis.rs
