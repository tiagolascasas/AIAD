...
public abstract class SemaphoricAgent extends RoadAgent {
	...
	private int secondsOnGreen = 0;
	private int secondsOnRed = 0;
	private ArrayList<Integer> greenTimes;
	private ArrayList<Integer> redTimes;
	...
	public SemaphoricAgent(int id, int[] semaphoricIDs, int[] connectableIDs, int capacity) {
		...
		this.greenTimes = new ArrayList<>();
		this.redTimes = new ArrayList<>();
	}
	...
	public void switchState(SemaphoreStates wantedState) {
		...
		if (this.state == SemaphoreStates.GREEN) {
			this.redTimes.add(this.secondsOnRed);
			this.secondsOnRed = 0;
		} else {
			this.greenTimes.add(this.secondsOnGreen);
			this.secondsOnGreen = 0;
		}
	}
	...
	public ArrayList<Integer> getGreenTimes() {
		return greenTimes;
	}

	public void setGreenTimes(ArrayList<Integer> greenTimes) {
		this.greenTimes = greenTimes;
	}

	public ArrayList<Integer> getRedTimes() {
		return redTimes;
	}

	public void setRedTimes(ArrayList<Integer> redTimes) {
